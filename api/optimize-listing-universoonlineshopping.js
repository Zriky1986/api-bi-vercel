export default async function handler(req, res) {
  ...
  const token = process.env.EBAY_PROD_USER_TOKEN_UNIVERSOONLINESHOPPING;
  if (!token) {
    console.error("[API optimize-listing-universoonlineshopping.js] Token eBay mancante (EBAY_PROD_USER_TOKEN_UNIVERSOONLINESHOPPING)");
