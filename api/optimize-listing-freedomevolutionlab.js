export default async function handler(req, res) {
  ...
  const token = process.env.EBAY_PROD_USER_TOKEN_FREEDOMEVOLUTIONLAB;
  if (!token) {
    console.error("[API optimize-listing-freedomevolutionlab.js] Token eBay mancante (EBAY_PROD_USER_TOKEN_FREEDOMEVOLUTIONLAB)");
